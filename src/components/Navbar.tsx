                    ...
                    <div className="flex items-center justify-between h-16">
                        ...
                        <div className="flex items-center">
                            <a href="#" className="hover:text-gray-200 flex items-center space-x-2">
                                ...
                                <span className="font-bold">TEAM KHAOS</span>
                            </a>
                        ...
                        <div className="flex-1 flex items-center justify-center mx-4 sm:mx-8">
                            <div className="relative flex items-center w-full">
                                <svg className="h-5 w-5 text-gray-200 absolute left-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="hidden md:flex items-center space-x-6">
                            ...
                            <a href="#" className="hover:text-gray-200 flex items-center space-x-2">
                                <img src="https://placehold.co/40x40/ffffff/000000?text=Profile" alt="Logo de la página" className="h-10 w-auto rounded-full" />
                            </a>
