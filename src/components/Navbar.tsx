...
function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 bg-transparent bg-opacity-50 z-40 transform ${isOpen ? "translate-y-16" : "-translate-x-full"
          } transition-transform duration-300 ease-in-out`}
      >
        <div className="bg-gray-200 w-64 h-full shadow-lg p-6 relative">
          <button
            onClick={() => setIsOpen(false)}
            className="absolute top-4 right-4 text-gray-600 hover:text-black flex items-center"
          >
            <svg
